...
public class DialogDiyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dialogdiy);
        mContext = DialogDiyActivity.this;
        ...
        //加载自定义的那个View,同时设置下
        final LayoutInflater inflater = DialogDiyActivity.this.getLayoutInflater();
